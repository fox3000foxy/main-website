        ...
        "data": {
            ...
            "Users": {
                ...
                "data": {
                    ...
                    "USERFOLDER": {
                        "type": "folder",
                        "name": JSON.parse(localStorage.setting).person.name,
                        "info": {
                            "spid": "%user%",
                            "icon": "user"
                        },
...
const favs = {
    ...
    "https://stella.jsannier.fr/otakucompanion": `
	otakucompanion`,
}

const favsIcons = {
	"https://andrewstech.me":"https://avatars.githubusercontent.com/u/45342431",
	"https://stella.jsannier.fr/otakucompanion":"https://stella.jsannier.fr/otakucompanion/assets/icons/icon.png",
}